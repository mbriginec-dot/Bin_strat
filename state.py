...
Мультибіржова підтримка: параметр `symbol` у функціях нижче очікує СКОУП, що включає
біржу, наприклад "binance:BTC/USDT" (а не просто "BTC/USDT") — це і робить main.py.
Так рівні з різних бірж по одному активу не змішуються в стані.
"""
import json
import os
import config
